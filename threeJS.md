...
- name your project (name example: threejsproject)
- name your package (name example: threejspackage)
...
enter this command in your project directory. (You should already be in this folder)
...
In the command line terminal, run this command in your project folder:
...
* later on, when we are ready to get our site up to github pages we will make changes to this.
...
When you are satisfyed with the results of your 3d models, go back into your javascript file and be ready to make some changes.
When we were working locally, we had three js locally on our computer. Because we are pushing this up
to github pages, it wouldnt have access to the three js package. To accomodate for this, we will replace
the first set of import lines with these ones:
```
...
## Here is how my file directory looks for reference:
### Project Folder
![projectFolder](images/projectFolder.png)
### Contents of Project Folder
![contentsOfProjectFolder](images/contentsOfProjectFolder.png)
### Contents of Dist Folder
![contentsOfDistFolder](images/contentsOfDistFolder.png)